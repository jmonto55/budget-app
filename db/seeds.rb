...
Category.create(user_id: u1.id, name: 'Groceries', icon: 'https://img.icons8.com/2266EE/color/dog')
Category.create(user_id: u1.id, name: 'Investment', icon: 'https://img.icons8.com/2266EE/color/sport')
Category.create(user_id: u1.id, name: 'Rent', icon: 'https://img.icons8.com/2266EE/color/bank')
